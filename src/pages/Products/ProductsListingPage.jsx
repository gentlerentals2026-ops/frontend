...
const ProductsListingPage = () => {
  ...
  return (
    <Box sx={{ px: { xs: 2, md: 6 }, py: { xs: 3, md: 5 } }}>
      ...
      {!isLoading && !error && displayedProducts.length === 0 && <Typography sx={{ textAlign: "center", color: "#616161" }}>{query || category ? "No listings match your search." : "No listings available yet."}</Typography>}
